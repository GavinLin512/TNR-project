...
@section('page-header')
    ...
    <div class="quick-link-wrapper w-100 d-md-flex flex-md-wrap">
        <ul class="quick-links">
            ...
            <li><a class="text-muted" aria-current="page">新增最新消息</a></li>
        </ul>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ asset('/TNR-admin/news/store') }}" enctype="multipart/form-data">
                        @csrf
                        {{-- date --}}
